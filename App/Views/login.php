...
<head>
	...
	<meta charset="utf-8">
		...
		<link rel="stylesheet" href="<?php echo asset();?>vendor/bootstrap/css/bootstrap-responsive.css">
		<link rel="stylesheet" href="<?php echo asset();?>css/estilos.css">
	<title>biblioteca</title>
</head>
<body background="<?php echo asset();?>img/li.jpg" style="background-attachment: fixed" >

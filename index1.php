...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li>
              <a class="closer" href="desconectar.php"> Cerrar sesión </a>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <form action="insertar.php" method="post" enctype="multipart/form-data" autocomplete="false">
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Dirección: Calzada del Normalismo Mexiquense 14 El Arco, Centro, 51200 Valle de Bravo, Méx.<br>
            ...
            <li>
              <a class="cl" href="actualizar.php"> Usuarios </a>
